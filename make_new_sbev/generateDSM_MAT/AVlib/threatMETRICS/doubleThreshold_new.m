function [tmp_index_FB] = doubleThreshold_new(old_index_FB,tmp_predict_probability_index,Decision_index_count, Decision_index_probability,...
                                          NUM_FB, BUFFER_LENGTH, INDEX_FB_MODE,...
                                          THRESHOLD_FB_PROBABILITY)

tmp_index_FB = old_index_FB;
if NUM_FB == 5 % cannot decide CM52, 53
