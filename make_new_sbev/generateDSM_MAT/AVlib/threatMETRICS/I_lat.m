function [I_lat_out, I_long, TTC, x_p, d_br, d_w,  DLC, TLC]...
    = I_lat(rel_pos_x, rel_pos_y, rel_vel_x, rel_vel_y, Va,Vb,heading_angle, target_width, target_length, ego_length, distance_to_leftlane, distance_to_rightlane, I_LAT_PARAM)
...
if p_long ~= P_LONG_DEFAULT_VALUE %昏力
    if rel_vel_x < 0
