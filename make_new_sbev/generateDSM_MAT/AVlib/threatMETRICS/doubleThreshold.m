...
if NUM_FB == 8 % cannot decide CM52, 53
   
    INDEX_FB_MODE_NONE =0;
    ...
    for i_buff = 1:BUFFER_LENGTH
        if tmp_predict_probability_index(i_buff) == INDEX_FB_MODE_NOT_CRASH || tmp_predict_probability_index(i_buff) == INDEX_FB_MODE_NONE
        ...
        elseif tmp_predict_probability_index(i_buff) == INDEX_FB_MODE_CM % CM
