function [DSM_out, LANE_MARK_FLAG_out, EGO_SHAPE_FLAG_out] = DSMRGBPredictionPointCarMaker(DSM_in, State_trajectory, laneInfoL, laneInfoR, Target_X_pred, LANE_MARK_FLAG_in, EGO_SHAPE_FLAG_in, DSM_PARAM, TRAJ_PARAM, EGO_VEHICLE, TRACKING, SAMPLE_TIME)
% DSMRGBPredictionPointCarMaker function generates DSM with predicted state as point in RGB image for CarMaker data
%
% [DSM_out, LANE_MARK_FLAG_out, EGO_SHAPE_FLAG_out] = DSMRGBPredictionPointCarMaker(DSM_in, State_trajectory, laneInfoL, laneInfoR, Target_X_pred, LANE_MARK_FLAG_in, EGO_SHAPE_FLAG_in, DSM_PARAM, TRAJ_PARAM, EGO_VEHICLE, TRACKING, SAMPLE_TIME)
%
