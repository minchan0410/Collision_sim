function [DSM_out, LANE_MARK_FLAG_out, EGO_SHAPE_FLAG_out] = DSMRGBPredictionBoxRG3(DSM_in, State_trajectory, laneInfoL, laneInfoR,...
...
% DSMRGBPredictionBoxRG3 function generates DSM with predicted state as bounding box in RGB image for RG3 data
%
% [DSM_out, LANE_MARK_FLAG_out, EGO_SHAPE_FLAG_out] = DSMRGBPredictionBoxRG3(DSM_in, State_trajectory, laneInfoL, laneInfoR,...
