...
% I_LAT_PARAM.X_MAX = 20;
% I_LAT_PARAM.X_THRESHOLD = 0;
% I_LAT_PARAM.TTC_INVERSE_THRESHOLD = 5; % == TTC threshold 0.2s
I_LAT_PARAM.X_MAX = 4.5;
I_LAT_PARAM.X_THRESHOLD = -6;
I_LAT_PARAM.TTC_INVERSE_THRESHOLD = 2; % == TTC threshold 0.5s
