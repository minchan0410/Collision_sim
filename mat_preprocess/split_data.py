...
def split_dataset(train_ratio, val_ratio, test_ratio, suffix, use_ratio, seed):
    ...
    for folder_name in split_names.values():
        (base_dir / 'mat_txt' / folder_name).mkdir(parents=True, exist_ok=True)
...
if __name__ == '__main__':
    ...
    split_dataset(args.train, args.val, args.test, args.suffix, args.use_ratio, args.seed)